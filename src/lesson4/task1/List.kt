...
/**
{
    ...
    while (i < nStr.length) {
        when (nStr.length - i) {
            ...
            3, 6 -> resultStr += l4[nStr[i].digitToInt() - 1]
            ...
            4 -> {
                resultStr += l5[nStr[i].digitToInt() - 1]
                if (nStr[i + 1] == '0') i += 1
            }
            ...
            1 -> resultStr += l1[nStr[i].digitToInt() - 1]
        }
        i += 1
        resultStr += " "
    }
...

{
    ...
    while (i <= nStr.length) {
        when (nStr.length - i) {
            6 -> if (nStr[i+1] == '0') {
                resultStr += l4[nStr[i].digitToInt() - 1] + " "
                i += 1
            }
            else {
                resultStr += l4[nStr[i].digitToInt() - 1] + " "
